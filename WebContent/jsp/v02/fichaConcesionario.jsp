...
<jsp:include page="cabecera.jsp" flush="true">
	<jsp:param name="tituloDePagina" value="fichaConcesionario" />
</jsp:include>
...
if (RequestUtils.getStringParameterFromHashMap(hashMap, "eliminar") != null) {
	...
	try {
		...
		response.sendRedirect(request.getContextPath() + "/jsp/v02/listadoConcesionario.jsp"); // Redirección del response hacia el listado
	} catch (Exception ex) {
		...
		<div class="mx-auto col-sm-6">
			...
			<div class="card">
				...
				<div class="card-body">
					...
					<a href="listadoConcesionarios.jsp">Ir al listado de concesionario</a>
